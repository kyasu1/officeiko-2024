module Gen.Fetcher.KaitoriTicket exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "KaitoriTicket" ]


{-| submit: 
    (Result.Result Http.Error Route.KaitoriTicket.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "KaitoriTicket" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
