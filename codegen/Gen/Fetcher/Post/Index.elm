module Gen.Fetcher.Post.Index exposing (call_, moduleName_, submit, values_)
...
{-| submit: 
    (Result.Result Http.Error Route.Post.Index.ActionData -> msg)
