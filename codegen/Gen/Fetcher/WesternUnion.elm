module Gen.Fetcher.WesternUnion exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "WesternUnion" ]


{-| submit: 
    (Result.Result Http.Error Route.WesternUnion.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "WesternUnion" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
